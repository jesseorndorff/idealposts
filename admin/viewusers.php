    	...
    	<td>
        	<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0">
            	<tr>
                    ...
                    <td class="headtitle" width="15%">Blog Name</td>
                ...
                <?php
					...
					$query_pages="SELECT distinct users.*
								  FROM users
								  ORDER BY users.id
								  DESC
								  ";
                ...
                <tr>
                        ...
                        <td class="<?=($i%2==0)?'recordlist1':'recordlist2'?>" ><?=$row_pages->user_name?></td>
                    
                        <td class="<?=($i%2==0)?'recordlist1':'recordlist2'?>" ><?=$row_pages->email?></td>
                        <td class="<?=($i%2==0)?'recordlist1':'recordlist2'?>" ><?=$row_pages->blog_name?></td>
